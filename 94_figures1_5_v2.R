...
#write in all files 
#save variables in rds
# saveRDS(ad_cd3_exprs,
#         file = paste0(dropbox.wd$`Discovery cohort`,
#                       "CD3+/Data files/ad_cd3_exprs.RData"))
# all_var_list_v0 <- list(tmp.pval.3t.reci.mtx.t,luminex_c1c2_df_v0117_v2,
#                         lcr.mtx.reci.mtx.t,c1c2_prop_df_v1_labs_updated,
#                         c1c2_prop_df_v1,c1c2_prop_df_v1_labs_fc_labs,
#                         
#                         )

write.xlsx(tmp.pval.3t.reci.mtx.t,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure1.xlsx"),
           sheetName = "A.tmp.pval.3t.reci.mtx.t")
write.xlsx(luminex_c1c2_df_v0117_v2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure1.xlsx"),
           sheetName = "B.luminex_c1c2_df_v0117_v2",
           append = TRUE)
write.xlsx(lcr.mtx.reci.mtx.t,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure1.xlsx"),
           sheetName = "C.lcr.mtx.reci.mtx.t",
           append = TRUE)

write.xlsx(c1c2_prop_df_v1_labs_updated,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure2.xlsx"),
           sheetName = "A.c1c2_prop_df_v1_labs_updated",
           append = FALSE)
write.xlsx(c1c2_prop_df_v1,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure2.xlsx"),
           sheetName = "B.c1c2_prop_df_v1",
           append = TRUE)

write.xlsx(c1c2_prop_df_v1_labs_fc_labs,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure2.xlsx"),
           sheetName = "C.c1c2_prop_df_v1_labs_fc_labs",
           append = TRUE)

write.xlsx(c1c2_prop_df_v1_labs_fc_labs,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure2.xlsx"),
           sheetName = "D.c1c2_prop_df_v1_labs_fc_labs",
           append = TRUE)
write.xlsx(c1c2_prop_df_v1_labs_survival_post1,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure2.xlsx"),
           sheetName = "E.c1c2_prop_df_v1_labs_survival_post1",
           append = TRUE)

write.xlsx(c1c2_prop_df_v1_labs_survival_post1,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure2.xlsx"),
           sheetName = "F.c1c2_prop_df_v1_labs_survival_post1",
           append = TRUE)

write.xlsx(tmp.scs.corr,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure3.xlsx"),
           sheetName = "A.tmp.scs.corr",
           append = FALSE)
write.xlsx(tmp.scs.corr.pval,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure3.xlsx"),
           sheetName = "A.tmp.scs.corr.pval",
           append = TRUE)
write.xlsx(luminex_c1c2_df_v0117_v2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure4.xlsx"),
           sheetName = "A.luminex_c1c2_df_v0117_v2",
           append = FALSE)
write.xlsx(df_v2_0126,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure4.xlsx"),
           sheetName = "B.df_v2_0126",
           append = TRUE)
...
write.xlsx(od_ratio_table_v2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure4.xlsx"),
           sheetName = "B.od_ratio_table_v2",
           append = TRUE)
write.xlsx(surv_mat_v230309,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure4.xlsx"),
           sheetName = "C.surv_mat_v230309",
           append = TRUE)

write.xlsx(surv_mat_score1to2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure4.xlsx"),
           sheetName = "D.surv_mat_score1to2",
           append = TRUE)

write.xlsx(prop.m,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure5.xlsx"),
           sheetName = "A.prop.m",
           append = FALSE)
write.xlsx(tmp.pre.pval.for.priorIO.reci.mtx.t,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure5.xlsx"),
           sheetName = "B.tmp.pre.pval.for.priorIO.reci.mtx.t",
           append = TRUE)
write.xlsx(df_v2_0126_cytokines_only_na_omit,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure5.xlsx"),
           sheetName = "C.df_v2_0126_cytokines_only_na_omit",
           append = TRUE)

write.xlsx(luminex_c1c2_df_v0117_v2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure5.xlsx"),
           sheetName = "D.luminex_c1c2_df_v0117_v2",
           append = TRUE)
write.xlsx(luminex_c1c2_df_v0117_v2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure5.xlsx"),
           sheetName = "E.luminex_c1c2_df_v0117_v2",
           append = TRUE)
write.xlsx(luminex_c1c2_df_v0117_v2,
           file = paste0(dropbox.wd$`project cytokines`,"additional analysis/20240603/",
                         "data_file_reproducibility/","Figure5.xlsx"),
           sheetName = "F.luminex_c1c2_df_v0117_v2",
           append = TRUE)
